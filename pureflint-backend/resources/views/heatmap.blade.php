...
function initMap() {
  map = new google.maps.Map(document.getElementById('map'), {
    zoom: 13,
    center: {lat: 43.0100, lng: -83.6900},
...
*/
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAeryvEAf5PNAmqcC6zAdQq2glGwQISTXI&signed_in=true&libraries=visualization&callback=initMap">
    </script>
  </body>
</html>